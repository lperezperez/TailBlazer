namespace TailBlazer.Domain.StateHandling
{
    ...
    public class StateBucketConverter : IConverter<StateBucket[]>
    {
        ...
        public StateBucket[] Convert(State state)
        {
            ...
            var files = root.Elements(Structure.Bucket).Select
                (
                 element =>
                     {
                         ...
                         var stateVersion = innerState.Attribute(Structure.Version).Value.ParseInt().ValueOr(() => 1);
                 ...
                 bucket =>
                     {
                         ...
                         return new XElement(Structure.Bucket, new XAttribute(Structure.Type, bucket.Type), new XAttribute(Structure.Id, bucket.Id), new XAttribute(Structure.Timestamp, bucket.TimeStamp), itemState);
                     });
        ...
        public StateBucket[] GetDefaultValue() => new StateBucket[0];
        #endregion
        #region Classes
