namespace TailBlazer.Domain.FileHandling
{
    ...
    public static class FileSearchEx
    {
        ...
        public static IObservable<FileSearchResult> Search(this IObservable<FileSegmentCollection> source, Func<string, bool> predicate, IScheduler scheduler = null)
        {
            ...
            var searcher = Observable.Create<FileSearchResult>
                (
                 observer =>
                     {
        ...
        public static IEnumerable<T> SearchLines<T>(this StreamReaderExtended source, Func<string, bool> predicate, Func<long, T> selector, Func<string, long, bool> shouldBreak)
        {
