namespace TailBlazer.Domain.FileHandling
{
    ...
    public static class IndexEx
    {
        ...
        public static IObservable<ILineProvider> Index(this FileInfo source, IScheduler scheduler = null)
        {
            ...
            return source.WatchFile(scheduler: scheduler).WithSegments().Index();
        }
        public static IObservable<ILineProvider> Index(this IObservable<FileSegmentCollection> source)
        {
            ...
            var idx = Observable.Create<IndexCollection>
                (
                 observer =>
                     {
            ...
            return searchFactory.TakeUntil(nameChanged).TakeWhile(x => x.sizeDiff >= 0).Repeat().Select(x => x.search);
        }
        public static IObservable<ILineProvider> Index(this IObservable<FileNotification> source) => source.WithSegments().Index();
        #endregion
    }
}