namespace TailBlazer.Fixtures
{
    ...
    public class StringExFixture
    {
        ...
        #endregion
        #region Constructors
        public StringExFixture(ITestOutputHelper output) { this.output = output; }
        #endregion
        #region Methods
        [Fact]
        ...
        [Theory, InlineData((long)12 * 1024 * 1024), InlineData((long)12 * 1024 * 1024 + 1234567), InlineData((long)3 * 1024 * 1024 * 1024 + 987652342)]
        public void FormatWithAbbreviationShouldBeEquivalentToFormatWithAbbreviationOld(long input)
        {
            ...
            this.output.WriteLine($"calculation for {result} took new: {resultTime} old: {resultOldTime}");
        }
        [Fact]
