namespace TailBlazer.Fixtures
{
    ...
    public class SettingsConversion
    {
        ...
        [Fact]
        public void GeneralOptionsWithCultureDeDe() { this.SerializeAndDeserializeWithCulture("de-DE"); }
        [Fact]
        public void GeneralOptionsWithCultureEnUs() { this.SerializeAndDeserializeWithCulture("en-Us"); }
        [Fact]
        ...
        {
            var files = new[] { new RecentFile(new FileInfo(@"C:\\File1.txt")), new RecentFile(new FileInfo(@"C:\\File2.txt")) };
